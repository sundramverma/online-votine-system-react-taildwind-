...
const RemoveCandidate = ({ onClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!otpSent) {
      alert("Please verify OTP before removing candidate!");
      return;
    }
    ...
    alert(`Candidate "${formData.name}" removed successfully!`);
    console.log("Candidate Removed:", formData);
    onClose();
  };
